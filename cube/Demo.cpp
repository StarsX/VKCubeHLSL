...
void Demo::createShaders()
{
	...
	m_pShader->CreateFragmentShader(0ui8, "PSBasePass.spv");
	m_pShader->CreateVertexShader(1ui8, "VSSSQuad.spv");
	m_pShader->CreateFragmentShader(1ui8, "PSIlluminate.spv");
}
...
void Demo::createPipelines()
{
	...
	// Shading pass
	{
		...
		pDescSet->AttachTextures(1ui8,
			...
			VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE);
		//pDescSet->AttachTextures(2ui8,
		//	m_ppGBuffers, VK_SHADER_STAGE_FRAGMENT_BIT);
		pDescSet->Create();
